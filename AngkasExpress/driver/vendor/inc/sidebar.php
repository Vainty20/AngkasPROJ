      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <h6 class="dropdown-header"><?php echo $row->u_fname;?> <?php echo $row->u_lname;?></h6>
              <a class="dropdown-item" href="driver-profile.php">View</a>
              <a class="dropdown-item" href="driver-update-profile.php">Update</a>
              <a class="dropdown-item" href="driver-change-pwd.php">Change Password</a>
